...
\end{proposition}
\begin{proof}
    We show that $K'$ is nilpotent. This would imply that $K'$ is solvable. Furthermore, we know that $\quotient{K}{K'}$ is abelian, and hence, solvable. Therefore, $K$ is itself solvable. % Turn this into a separate result...
