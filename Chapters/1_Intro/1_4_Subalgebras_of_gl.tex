...
Weight spaces are rather interesting, and in the remainder of this subsection, we will develop some theory that will prove quite useful when we prove Lie's Theorem (\Cref{Ch1:Thm:Lie}, which we shall see shortly).
