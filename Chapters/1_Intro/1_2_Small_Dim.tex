...
\begin{corollary}\label{Ch1:Cor:1D_Lie_Algebra_Classification}
...
The reason we are interested in the above example will become clear imminently. For the remainder of this section, we will reserve the notation $L$ for the Lie algebra described in \Cref{Ch1:Eg:2D_NonAbelian_Lie_Algebra} and let $K$ denote an arbitrary non-abelian Lie subalgebra of dimension $2$.

We will begin by describing the derived subalgebra $K'$ (cf. \Cref{Ch1:Def:DerivedSubalg}) of $K$.
