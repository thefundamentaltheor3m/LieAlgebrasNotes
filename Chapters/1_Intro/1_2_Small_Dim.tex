...
The reason we are interested in the above example will become clear imminently. For the remainder of this section, we will reserve the notation $L$ for the Lie algebra described in \Cref{Ch1:Eg:2D_NonAbelian_Lie_Algebra} and denote by $K$ an arbitrary non-abelian Lie subalgebra of dimension $2$.
